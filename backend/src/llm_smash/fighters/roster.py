    ...
    return Fighter(
        ...
        abilities=[
            ...
            Ability(
                ...
                cooldown_remaining=0,
                range=4,
                description="15 dmg + reveals opponent's next planned action.",
            ),
            Ability(
                ...
                cooldown_remaining=0,
                range=6,
                description="Forces opponent to output gibberish next turn (stun).",
            ),
        ],
    )
    ...
    return Fighter(
        ...
        abilities=[
            ...
            Ability(
                ...
                cooldown_remaining=0,
                range=3,
                description="Places a trap at target location. 15 dmg on trigger.",
            ),
            Ability(
                ...
                cooldown_remaining=0,
                range=3,
                description="Massive cognitive overload burst. 40 dmg + 2 turn slow.",
            ),
        ],
    )
    ...
    return Fighter(
        ...
        abilities=[
            ...
            Ability(
                ...
                cooldown_remaining=0,
                range=0,
                description="Blocks next 30 dmg, reflects 50% back.",
            ),
            Ability(
                ...
                cooldown_remaining=0,
                range=6,
                description="Absorbs all projectiles on field, converts to HP.",
            ),
        ],
    )
    ...
    return Fighter(
        ...
        abilities=[
            ...
            Ability(
                ...
                cooldown_remaining=0,
                range=0,
                description="Sacrifice 15 HP for +30% damage for 3 turns.",
            ),
            Ability(
                ...
                cooldown_remaining=0,
                range=0,
                description="Sacrifice 25 HP for +50% damage for 2 turns.",
            ),
        ],
    )
